...
<html lang="en">
  <head>
    ...
    <title>Project DSV - Real/Fake Product Identification Dapp</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to Project DSV - Real/Fake Product Identification Dapp</h4>
            <p style="max-width: 80%;">
            Project DSV is a Decentralized E2E Logistics Application that stores the whereabouts of product at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and get complete information about the provenance of that product hence empowering consumers to only purchase authentic and quality products.
            </p>
